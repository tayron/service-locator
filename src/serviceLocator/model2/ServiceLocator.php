<?php
namespace MyApplication\serviceLocator\model2;

/**
 * Implementação de um service locator
 * 
 * @see http://designpatternsphp.readthedocs.io/pt_BR/latest/More/ServiceLocator/README.html
 */
